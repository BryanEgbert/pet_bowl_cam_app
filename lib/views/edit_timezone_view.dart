...
class EditTimezoneView extends StatefulWidget {
  const EditTimezoneView(
...
class _EditTimezoneViewState extends State<EditTimezoneView> {
  final Map<String, String> searchedTimezones = {};
